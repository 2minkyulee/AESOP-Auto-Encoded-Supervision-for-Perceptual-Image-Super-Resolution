...
| Recon. Objective    |            | $L_\text{pix}$ | $L_\text{pix}$ | $L_\text{pix}$ | **$L_\text{AESOP}$** | **$L_\text{AESOP}$** | $L_\text{pix}$ | $L_\text{pix}$ | **$L_\text{AESOP}$** | **$L_\text{AESOP}$** |
| Patch Size Training |            |       128      |       128      |       128      |          128         |          256         |       256      |       256      |          256         |          256         |
